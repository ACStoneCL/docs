...
<<<<<<<< HEAD:source/docs/casper/users/ledger/staking-ledger.md
...
>>>>>>>> ea29b81ef (workflow):source/docs/casper/workflow/users/staking-ledger.md
...
========
3. When logging in to [cspr.live](https://cspr.live/), the UI will offer numerous public keys. Choose any of them. They are all derived from the Master Seed that is secured in the Ledger key ([more info here](https://www.ledger.com/back-to-basics-part-1where-are-my-coins)). Make sure you write down whichever public key(s) you end up using so that you have no confusion when trying to log in.
>>>>>>>> ea29b81ef (workflow):source/docs/casper/workflow/users/staking-ledger.md
