...
<<<<<<<< HEAD:source/docs/casper/developers/cli/transfers/direct-token-transfer.md
1.  You meet the [prerequisites](../../prerequisites.md)
========
1.  You meet the [prerequisites](/dapp-dev-guide/setup.md)
>>>>>>>> ea29b81ef (workflow):source/docs/casper/workflow/developers/transfer-workflow.md
